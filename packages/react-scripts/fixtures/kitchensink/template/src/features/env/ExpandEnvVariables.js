...
const ExpandEnvVariables = () => (
  <span>
    ...
    <span id="feature-expand-env-3">{process.env.REACT_APP_BASIC_EXPAND_SIMPLE}</span>
    <span id="feature-expand-env-existing">{process.env.REACT_APP_EXPAND_EXISTING}</span>
  </span>
);
